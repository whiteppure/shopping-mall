!function (t, e, a, n) {
    ...
    t.extend(i.prototype, {
        init: function () {
            ...
            var t = this;
            t.cart.parent().append('<button class="' + t.settings.cart + '-clear">清空商品</button>'), t.cart.parent().append('<!-- <button type="submit" class="' + t.settings.cart + '-checkout">添加到购物车</button> -->'), t.clear_cart(), t.checkout_button()
        }, checkout: function () {
            var e, a = this, n = {cmd: "_cart", upload: 1}, i = t("<form />"),
                r = {name: "item_name", quantity: "quantity", amount: "amount"};
            t.extend(n, a.settings.paypal), i.attr("action", "http://localhost:8082/order"), i.attr("method", "get"), i.attr("target", "_blank");
